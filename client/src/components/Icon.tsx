...
const P: Record<IconName, ReactNode> = {
  ...
  broom: <>
    <path d="m13 13.7-9 9" />
    <path d="m20.2 3.8a2 2 0 0 0-2.8 0l-6.2 6.2a1 1 0 0 0 0 1.4l3.4 3.4a1 1 0 0 0 1.4 0l6.2-6.2a2 2 0 0 0 0-2.8Z" />
    <path d="M4 21 3 20c-.3.3-.5.5-.7.9a1 1 0 0 0 1.3 1.3c.4-.3.6-.5.9-.7Z" />
  </>,
